...
It manages its own conversation history, parses model JSON actions, executes
local tools, reads and writes files inside a guarded workspace, runs shell
commands, observes errors, and iterates until it reaches a final answer or a
step limit. A mock model is included for deterministic demonstration and tests.
